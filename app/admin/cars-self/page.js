...
export default function AdminSelfDriveCars() {
  ...
  const fetchCars = async () => {
    try {
      // Get all cars and filter for self-drive or both
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div>
          <div className="bg-zinc-50 border border-zinc-200 shadow-sm rounded-3xl p-6 sticky top-8">
            <h3 className="text-lg font-black text-charcoal-900 uppercase tracking-tight mb-4 flex items-center gap-2"><Plus className="size-5 text-brand-500"/> Add New Self-Drive Car</h3>
            <form onSubmit={handleAddCar} className="space-y-4">
              <input name="name" placeholder="Car Name (e.g. Swift)" required className="w-full bg-white border border-zinc-200 h-12 rounded-xl px-4 text-charcoal-900 placeholder:text-zinc-400 focus:border-brand-500 focus:outline-none" />
              <input name="brand" placeholder="Brand (e.g. Maruti)" required className="w-full bg-white border border-zinc-200 h-12 rounded-xl px-4 text-charcoal-900 placeholder:text-zinc-400 focus:border-brand-500 focus:outline-none" />
              <div className="grid grid-cols-2 gap-4">
                <input name="type" placeholder="Category (e.g. Hatchback)" required className="w-full bg-white border border-zinc-200 h-12 rounded-xl px-4 text-charcoal-900 placeholder:text-zinc-400 focus:border-brand-500 focus:outline-none" />
                <select name="serviceType" defaultValue="self-drive" required className="w-full bg-white border border-zinc-200 h-12 rounded-xl px-4 text-charcoal-900 focus:border-brand-500 focus:outline-none appearance-none">
              ...
              <input name="fuel" placeholder="Fuel Type" required className="w-full bg-white border border-zinc-200 h-12 rounded-xl px-4 text-charcoal-900 placeholder:text-zinc-400 focus:border-brand-500 focus:outline-none" />
