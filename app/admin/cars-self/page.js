...
export default function AdminSelfDriveCars() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-black text-white uppercase tracking-tight mb-8">Manage Self-Drive Cars</h2>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div>
          <div className="bg-slate-950 border border-slate-800 rounded-3xl p-6 sticky top-8">
            <h3 className="text-lg font-black text-white uppercase tracking-tight mb-4 flex items-center gap-2"><Plus className="size-5 text-amber-500"/> Add New Self-Drive Car</h3>
            <form onSubmit={handleAddCar} className="space-y-4">
              <input name="name" placeholder="Car Name (e.g. Swift)" required className="w-full bg-slate-900 border border-slate-800 h-12 rounded-xl px-4 text-white" />
              <input name="brand" placeholder="Brand (e.g. Maruti)" required className="w-full bg-slate-900 border border-slate-800 h-12 rounded-xl px-4 text-white" />
              <div className="grid grid-cols-2 gap-4">
                <input name="type" placeholder="Category (e.g. Hatchback)" required className="w-full bg-slate-900 border border-slate-800 h-12 rounded-xl px-4 text-white" />
                <select name="serviceType" defaultValue="self-drive" required className="w-full bg-slate-900 border border-slate-800 h-12 rounded-xl px-4 text-white appearance-none">
              ...
              <input name="fuel" placeholder="Fuel Type" required className="w-full bg-slate-900 border border-slate-800 h-12 rounded-xl px-4 text-white" />
