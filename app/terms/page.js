      ...
      <section className="py-32">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="space-y-16">
             ...
             <div className="bg-slate-50 rounded-[40px] p-10 lg:p-14 border border-slate-100">
                <h2 className="text-3xl font-black uppercase tracking-tight text-slate-900 mb-8 flex items-center gap-4">
                   <div className="size-10 bg-amber-500 rounded-xl flex items-center justify-center text-slate-950"><Zap className="size-5" /></div>
                   Booking & Eligibility
                </h2>
             ...
             <div className="grid md:grid-cols-2 gap-8">
                <div className="p-10 bg-white border border-slate-100 rounded-[40px] shadow-xl shadow-slate-100">
                   <h3 className="text-xl font-black uppercase tracking-tight text-slate-900 mb-6">Usage Policy</h3>
                ...
                <div className="p-10 bg-white border border-slate-100 rounded-[40px] shadow-xl shadow-slate-100">
                   <h3 className="text-xl font-black uppercase tracking-tight text-slate-900 mb-6">Cancellations</h3>
                   <p className="text-slate-500 text-sm leading-relaxed font-medium">
             ...
             <div className="p-10 border-2 border-dashed border-slate-100 rounded-[40px]">
