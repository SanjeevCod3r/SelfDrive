          ...
          <div className="space-y-20">
             ...
             <div className="space-y-6">
                <div className="flex items-center gap-4 mb-8">
                   ...
                   <h2 className="text-3xl font-black uppercase tracking-tight text-slate-900">Information We Collect</h2>
                </div>
             ...
             <div className="space-y-6">
                <div className="flex items-center gap-4 mb-8">
                   ...
                   <h2 className="text-3xl font-black uppercase tracking-tight text-slate-900">How We Use Your Data</h2>
                </div>
                <p className="text-slate-500 leading-relaxed font-medium text-lg">
             ...
             <div className="space-y-6">
                <div className="flex items-center gap-4 mb-8">
                   ...
                   <h2 className="text-3xl font-black uppercase tracking-tight text-slate-900">Data Security</h2>
                </div>
                <p className="text-slate-500 leading-relaxed font-medium text-lg">
