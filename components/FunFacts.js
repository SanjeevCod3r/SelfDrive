...
export default function FunFacts() {
  return (
    <section className="py-24 bg-white overflow-hidden border-t border-zinc-200">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
          {facts.map((fact, idx) => (
            ...
            >
              ...
              <h3 className="text-4xl md:text-6xl font-black text-charcoal-900 uppercase tracking-tighter mb-2 group-hover:text-amber-500 transition-colors">
                {fact.number}
              </h3>
        ...
        <div className="mt-20 pt-16 border-t border-zinc-200 flex flex-col md:flex-row items-center justify-between gap-10">
           <div className="flex items-center gap-4">
              <div className="flex -space-x-3">
                 {[1,2,3,4].map(i => (
                   <div key={i} className="size-12 rounded-full border-4 border-white bg-zinc-100 overflow-hidden">
              ...
              <div>
                 ...
                 <p className="text-[10px] font-black uppercase tracking-widest text-zinc-500">Trusted by thousands of drivers</p>
              </div>
           </div>
           ...
           <div className="flex items-center gap-8">
              ...
              <div className="text-center md:text-left">
                 <p className="text-2xl font-black text-charcoal-900 uppercase tracking-tight">4.9/5</p>
                 <p className="text-[9px] font-black uppercase tracking-widest text-zinc-500">Global Customer Rating</p>
              </div>
           </div>
        </div>
      </div>
